...
public class MovementReport {
	...
	public MovementReport(String client, int category, int typemovement, String ship,
			String startmovement, String endmovement) throws ParseException {
		this.client = client;
	...
	public void setStartmovement(String startmovement) throws ParseException {
		this.startmovement = new SimpleDateFormat("yyyy-MM-dd").parse(startmovement);
	}
	...
	public void setEndmovement(String endmovement) throws ParseException {
		this.endmovement = new SimpleDateFormat("yyyy-MM-dd").parse(endmovement);
	}
